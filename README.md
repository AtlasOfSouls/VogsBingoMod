...
If you use the custom-made set of goals maintained by the Silksong Bingo community, the mod will also automatically mark squares as you complete them. Goals outside this set will be listed with an (M) for "manual mark", which you will have to click yourself.
